...
"""Dataset Path"""
C.dataset_name = 'NPO++'
C.dataset_path = osp.join(C.root_dir, 'NPO++')
C.rgb_root_folder = osp.join(C.dataset_path, 'left')
C.rgb_format = '.png'
...
C.is_test = False
C.num_train_imgs = 2300
C.num_eval_imgs = 1150
...
# C.pretrained_model = C.root_dir + '/pretrained/mit_b2.pth'   # Using for training
C.pretrained_model = None                                      # Using for testing
...
C.eval_crop_size = [288, 512] # [height weight]
